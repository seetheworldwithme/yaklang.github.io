        ...
        metadata: [
            {
                name: "description",
                content:
                    "Yak Project 是以 Yaklang 为核心的开源网络安全基础设施，提供 Yakit、IRify、AI Agent 与安全研发文档。",
            },
            { property: "og:site_name", content: "Yak Project" },
            { property: "og:image", content: `${siteUrl}/img/yaklogo.png` },
            { name: "twitter:card", content: "summary_large_image" },
            { name: "twitter:image", content: `${siteUrl}/img/yaklogo.png` },
        ],
        colorMode: {
            // "light" | "dark"
            defaultMode: "light",
